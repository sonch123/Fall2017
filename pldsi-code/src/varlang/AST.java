...
public interface AST {
	...
	public static class LeteExp extends Exp {
		...
		public LeteExp(NumExp num, List<String> names, List<Exp> value_exps, Exp body) {
			_names = names;
			_value_exps = value_exps;
			_body = body;
			_num = num;
	...
	public static class DecExp extends Exp{
		...
		public DecExp(Exp num, Exp body) {
			_body = body;
			_num = num;
		}
		
		public Exp num() { return _num;}
